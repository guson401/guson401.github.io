(function () {
  ...
  const dictionaries = {
    en: {
      ...
      "Awards": "Awards",
      "삼성청년SW,AI아카데미 프로젝트 우수상(3등)": "Samsung Youth SW/AI Academy Project Excellence Award (3rd Place)",
      "삼성전자 · 2026.03": "Samsung Electronics · Mar 2026",
      "삼성청년SW,AI아카데미 성적우수상": "Samsung Youth SW/AI Academy Academic Excellence Award",
      "삼성전자 · 2025.12": "Samsung Electronics · Dec 2025",
      "기술 스택": "Tech Stack",
      ...
      "Medicare 메인 화면 이미지": "Medicare main screen image",
      "Medicare 증상 입력 화면": "Medicare symptom input screen",
      "Medicare 메인 화면": "Medicare main screen",
      ...
      "메인 화면은 증상 입력과 병원 검색 진입점을 한 화면에 배치해 사용자가 바로 필요한 흐름을 선택할 수 있게 구성했습니다.": "The main screen places symptom input and hospital-search entry points on a single screen so users can immediately choose the flow they need.",
      ...
      "자연어 증상 입력 영역과 AI 추천 흐름의 시작점을 상단에 배치": "Places the natural-language symptom input area and AI recommendation starting point at the top",
      "병원 검색, 방문 기록, 커뮤니티로 이어지는 주요 기능 진입점을 노출": "Exposes entry points to hospital search, visit records, and community flows",
      "의료 정보 탐색 전 단계에서 사용자의 다음 행동을 빠르게 선택하도록 구성": "Helps users quickly choose their next action before exploring medical information",
    ...
    ja: {
      ...
      "Awards": "受賞歴",
      "삼성청년SW,AI아카데미 프로젝트 우수상(3등)": "Samsung青年SW・AIアカデミー プロジェクト優秀賞（3位）",
      "삼성전자 · 2026.03": "サムスン電子 · 2026.03",
      "삼성청년SW,AI아카데미 성적우수상": "Samsung青年SW・AIアカデミー 成績優秀賞",
      "삼성전자 · 2025.12": "サムスン電子 · 2025.12",
      "기술 스택": "使用技術",
      "전체 요약": "全体要約",
      "언어": "言語",
      ...
      "Medicare 메인 화면 이미지": "Medicareメイン画面画像",
      "Medicare 증상 입력 화면": "Medicare症状入力画面",
      "Medicare 메인 화면": "Medicareメイン画面",
      ...
      "메인 화면은 증상 입력과 병원 검색 진입점을 한 화면에 배치해 사용자가 바로 필요한 흐름을 선택할 수 있게 구성했습니다.": "メイン画面では症状入力と病院検索への入口を1つの画面に配置し、ユーザーが必要な流れをすぐ選べるように構成しました。",
      "메인 화면에서 자연어 증상 입력과 병원 검색 진입점을 제공": "メイン画面で自然言語の症状入力と病院検索への入口を提供",
      "자연어 증상 입력 영역과 AI 추천 흐름의 시작점을 상단에 배치": "自然言語の症状入力エリアとAI推薦フローの開始点を上部に配置",
      "병원 검색, 방문 기록, 커뮤니티로 이어지는 주요 기능 진입점을 노출": "病院検索、訪問記録、コミュニティへ続く主要機能の入口を表示",
      "의료 정보 탐색 전 단계에서 사용자의 다음 행동을 빠르게 선택하도록 구성": "医療情報を探索する前段階で次の行動を素早く選べるように構成",
